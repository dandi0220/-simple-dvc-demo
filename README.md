...
[![](https://drive.google.com/uc?id=15YtHu0fg6ilhgAnEK1VpHidqv1g3udVW)](https://indian-currency-prediction.herokuapp.com/)
...
In addition, if you are interested in building this pipeline from scratch, please find the specification document to guide you through here. 
...
│                         generated with `pip -r requirements.txt`
├── setup.py
├── template.py
...
│   ├── .gitkeep
│   ├── __init__.py    <- Makes src a Python module
│   ├── get_data.py    <- source code to ## read params,process the data and return dataframe
│   ├── load_data.py
